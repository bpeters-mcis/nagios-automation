...
$ServicesToMonitor = array('D' => array('use' => 'generic-service',
                            ...
                            'EvWu12072' => array('use' => 'generic-service',
                                ...
                                'check_command' => 'check_event_viewer!application!120mm!Windows Server Update Services!12072',
                                'normal_check_interval' => '10',
                                'retry_check_interval' => '2',
                                'host_name' => ''),
                            ...
                            'EvWu10042' => array('use' => 'generic-service',
                                ...
                                'retry_check_interval' => '2',
                                'host_name' => ''),
                            'EvWu1000' => array('use' => 'generic-service',
                                'service_description' => 'VMWare Tools Event 1000',
                                'check_command' => 'check_event_viewer!application!250m!VMware Tools!1000',
                                'normal_check_interval' => '10',
                                'retry_check_interval' => '2',
                                'host_name' => ''),
